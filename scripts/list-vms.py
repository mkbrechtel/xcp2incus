...
def main():
    ...
    # Collect data
    rows = []
    headers = ["TICKETID", "INFO", "VM NAME", "STATUS", "PLAN", "XCP HOST", "INCUS INSTANCE", "PRIMARY IP", "VDBS"]
    ...
    for vm_dir in vm_dirs:
        ...
        rows.append([ticketid, info, vm_name, formatted_status, plan, xcp_host, incus_instance, primary_ip, vdbs])
